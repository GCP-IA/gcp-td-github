...
description: Synchronize the centralized GCP-TD Vercel security workflow from GCP-TD/.github before creating or updating repositories.
---

# GCP-TD Vercel Security Workflow

Use this skill whenever a GCP-TD repository is created or updated.

## Required Workflow Source

The source of truth is:

`GCP-TD/.github/workflow-templates/seguridad-vercel.yml`

The workflow helper scripts are also centralized in:

`GCP-TD/.github/workflow-templates/scripts/`
...
`gh api -H "Accept: application/vnd.github.raw" repos/GCP-TD/.github/contents/workflow-templates/seguridad-vercel.yml`
...
1. Synchronize `.github/workflows/seguridad-vercel.yml` and `.github/devsecops/scripts/` from `GCP-TD/.github`.
2. Run local workflow self-check.
3. Create or update `GCP-TD/<repo>` with the requested visibility.
